...
2. **Chatbot (legacy)** — `min-h-[48px]` on all quick-reply buttons and Send in deprecated `components/ui/Chatbot.tsx` (current web chat path uses `components/ChatWidget.tsx`).
