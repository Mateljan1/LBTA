  ...
  return (
    <footer className="bg-[#FAF8F3]">
      ...
      <div className="border-b border-black/10">
        <div className="max-w-[1440px] mx-auto px-6 md:px-20 py-12 md:py-16">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-20 py-12 md:py-20">
        <div className="text-center">
          ...
          <div className="pt-8 border-t border-black/10">
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 text-[13px] text-[#777] font-sans">
