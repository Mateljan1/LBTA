    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div>
            <h2 className="font-headline text-2xl font-bold text-black">Registration Form Analytics</h2>
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-brand-tide-pool/10 to-brand-tide-pool/5 border border-brand-tide-pool/30 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-headline text-xl font-semibold text-black">Embedded Forms</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-headline text-2xl font-bold text-brand-tide-pool">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-headline text-xl font-semibold text-black">Modal Forms</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="font-sans text-sm text-black/60">Conversion Rate</p>
                    <p className="font-headline text-2xl font-bold text-blue-600">
          ...
          {overallFunnel && (
            <div className="bg-gray-50 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-headline text-xl font-semibold text-black">Overall Performance</h3>
              </div>
              <div className="grid md:grid-cols-5 gap-4">
                <div className="text-center">
                  <p className="font-sans text-sm text-black/60 mb-2">Program Views</p>
                  <p className="font-headline text-2xl font-bold text-black">{overallFunnel.programView}</p>
                </div>
                <div className="text-center">
                  <p className="font-sans text-sm text-black/60 mb-2">Form Starts</p>
                  <p className="font-headline text-2xl font-bold text-brand-sunset-cliff">{overallFunnel.formStart}</p>
                </div>
                <div className="text-center">
                  <p className="font-sans text-sm text-black/60 mb-2">Form Completes</p>
                  <p className="font-headline text-2xl font-bold text-brand-sunset-cliff">{overallFunnel.formComplete}</p>
                </div>
                <div className="text-center">
                  <p className="font-sans text-sm text-black/60 mb-2">Submissions</p>
                  <p className="font-headline text-2xl font-bold text-brand-tide-pool">{overallFunnel.formSubmit}</p>
                </div>
                <div className="text-center">
                  <p className="font-sans text-sm text-black/60 mb-2">Conversion Rate</p>
                  <p className="font-headline text-2xl font-bold text-brand-tide-pool">{overallFunnel.conversionRate.toFixed(1)}%</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <h4 className="font-headline text-lg font-semibold text-blue-900 mb-3">Analytics Instructions</h4>
