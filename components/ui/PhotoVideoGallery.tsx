...
// Static imports for build-time optimization. Paths verified in public/photos/ (LBCOURTSETTING, VideoAnalysisRoom, GymSetting, OncourtTraining, Court setting). Legacy equivalents exist in legacy-working-assets/photos/ if switching. Asset size: images are 13–27MB each (high-res intentional for gallery quality). See docs/quality-gate.md or asset brief for optimization options if needed.
