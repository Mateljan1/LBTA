...
export default function PressBanner() {
  return (
    <section className="bg-white border-y border-lbta-stone/50 py-10 md:py-12">
      <div className="max-w-6xl mx-auto px-6">
        {/* Header */}
        <p className="font-sans text-[11px] uppercase tracking-[3px] text-lbta-slate/60 text-center mb-8">
          As Featured In
        </p>
        ...
        {/* Credentials Row */}
        <div className="mt-10 pt-8 border-t border-lbta-stone/30">
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10">
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-lbta-charcoal" fill="currentColor" viewBox="0 0 20 20">
