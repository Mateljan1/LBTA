        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-brand-sunset-cliff text-white rounded-full font-sans text-sm font-medium hover:bg-brand-sunset-cliff transition-colors disabled:opacity-50"
            >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <button
              onClick={runAllTests}
              disabled={isRunning}
              className="flex items-center gap-2 bg-brand-sunset-cliff hover:bg-brand-sunset-cliff text-white font-sans font-semibold py-3 px-8 rounded-full transition-colors disabled:opacity-50"
            >
            ...
            {isRunning && (
              <div className="flex-1 text-center">
                ...
                <div className="bg-gray-200 rounded-full h-2 w-full max-w-md mx-auto">
                  <div 
                    className="bg-brand-sunset-cliff h-2 rounded-full transition-all duration-300"
