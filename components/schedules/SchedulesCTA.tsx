...
export default function SchedulesCTA() {
  return (
    <section className="relative min-h-[400px] md:min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 py-20">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <Link
            href="/book"
            className="bg-black hover:bg-lbta-black text-white font-sans font-semibold text-[16px] py-4 px-10 rounded-full transition-all shadow-md hover:shadow-lg min-h-[48px]"
          >
            Book Trial
          </Link>
          <Link
