          ...
          <div className="flex items-center gap-3">
            {program.inquiryLabel && (
              <Link
                ...
                className="font-sans text-button uppercase text-brand-pacific-dusk/80 hover:text-brand-pacific-dusk underline underline-offset-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-black/30 focus-visible:ring-offset-2 min-h-[48px] inline-flex items-center"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 bg-black text-white font-sans text-button uppercase px-6 py-3 rounded-[2px] transition-all duration-300 ease-out hover:bg-gray-800 hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-black/30 focus-visible:ring-offset-2 min-h-[48px]"
            >
              Register
      ...
      <div className="md:hidden px-4 py-5 min-w-0">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={handleRegister}
            aria-label={`Register for ${program.program}`}
            className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-1.5 bg-black text-white font-sans text-button uppercase px-5 py-3 rounded-[2px] transition-all duration-300 ease-out active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-black/30 focus-visible:ring-offset-2 min-h-[48px]"
          >
            Register
            <svg className="w-3.5 h-3.5" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
