...
export default function CourtFlyer({
  ...
  return (
    <div className="court-flyer-print bg-brand-morning-light text-brand-pacific-dusk font-sans min-h-screen">
      ...
      {/* Header */}
      <header className="py-5 px-6 border-b-2 border-brand-pacific-dusk/15">
        <h1 className="font-headline text-2xl md:text-3xl font-semibold text-brand-deep-water tracking-tight uppercase text-center">
          Certified City of Laguna Beach Coaching Team
        </h1>
        <p className="text-center text-sm mt-2 text-brand-pacific-dusk/90">
          Only LBTA coaches are authorized to teach at City of Laguna Beach tennis courts.
        </p>
        <p className="text-center font-bold mt-3 text-brand-deep-water text-base">FREE TRIAL — Try Any Group Class</p>
      </header>

      {/* Coaches */}
      <section className="py-6 px-6">
        <h2 className="font-headline text-xl font-semibold text-brand-deep-water mb-4">Your Certified Coaching Team</h2>
      ...
      <section className="py-4 px-6">
        <h2 className="font-headline text-lg font-semibold text-brand-deep-water mb-2">Private Lessons</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b border-brand-pacific-dusk/20">
                <th className="text-left py-2 pr-4 font-medium">Coach</th>
                <th className="text-right py-2 px-2">60 min</th>
                <th className="text-right py-2 px-2">90 min</th>
                <th className="text-right py-2 px-2">10-pack</th>
                <th className="text-right py-2 px-2">20-pack</th>
              </tr>
            </thead>
            <tbody>
              {privateRates.map((r) => (
                <tr key={r.coach} className="border-b border-brand-pacific-dusk/10">
                  <td className="py-2 pr-4">{r.coach}</td>
      ...
      {/* CTA block — what to do at a glance */}
      <section className="py-5 px-6 bg-brand-sunset-cliff/15 border-y-2 border-brand-pacific-dusk/10">
        <p className="text-center font-headline font-semibold text-brand-deep-water text-lg mb-2">What to do</p>
        <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center text-sm font-medium">
        ...
        <p className="text-center text-sm mt-2 text-brand-pacific-dusk/90">{FLYER_ACADEMY_ADDRESS}</p>
      </section>

      {/* Reserved courts */}
      <section className="py-4 px-6 bg-brand-sandstone/40">
        <h2 className="font-headline text-lg font-semibold text-brand-deep-water mb-2">LBTA Reserved Courts</h2>
      ...
      <section className="py-4 px-6">
        <h2 className="font-headline text-lg font-semibold text-brand-deep-water mb-3">
        ...
        {locationOrder.map((loc) => {
          ...
          return (
            <div key={loc} className="mb-6 break-inside-avoid">
              <h3 className="font-headline font-semibold text-brand-deep-water text-sm uppercase mb-2">
      ...
      {/* Camps */}
      <section className="py-4 px-6 bg-brand-sandstone/30">
        <h2 className="font-headline text-lg font-semibold text-brand-deep-water mb-2">Camps</h2>
      ...
      {/* Program pricing */}
      <section className="py-4 px-6">
        <h2 className="font-headline text-lg font-semibold text-brand-deep-water mb-2">Program Pricing</h2>
        <h3 className="text-sm font-semibold mt-3 mb-1">Junior & Competitive</h3>
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="border-b border-brand-pacific-dusk/20">
        ...
        <h3 className="text-sm font-semibold mt-3 mb-1">Adult & Fitness</h3>
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="border-b border-brand-pacific-dusk/20">
              <th className="text-left py-1 pr-2">Program</th>
        ...
        <p className="text-xs mt-2 text-brand-pacific-dusk/80">{discountLine}</p>
      </section>

      {/* Footer */}
      <footer className="py-6 px-6 border-t-2 border-brand-pacific-dusk/15 bg-brand-deep-water text-white/90 text-center text-sm">
