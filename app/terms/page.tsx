        ...
        <div className="container-narrow prose prose-lg max-w-none">
          <AnimatedSection>
            <div className="space-y-8 body-text">
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Acceptance of Terms</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Program Registration</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Cancellation Policy</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Code of Conduct</h2>
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Liability</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Photography and Media</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Changes to Terms</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-display font-light text-brand-deep-water mb-4">Contact</h2>
                <p>
