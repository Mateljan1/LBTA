...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      // Log error but continue - Notion has the data, AC sync can happen via webhook
      console.log('⚠️ AC failed but Notion saved - registration will be synced via webhook')
    }
