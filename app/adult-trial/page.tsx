    ...
    <div className="min-h-screen bg-gradient-to-b from-lbta-bone to-lbta-sand">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-lbta-secondary mb-8 leading-relaxed">
              Start or elevate your tennis journey with ATP/WTA-level coaching. Whether you're a complete beginner or returning player, we'll meet you where you are.
            </p>

            {/* Benefits */}
            <div className="space-y-4 mb-8">
              {[
                'Professional ATP/WTA coaching for all skill levels',
                'Flexible scheduling for busy professionals',
                'Small group or private lesson options',
                'Adult-focused instruction (ages 18+)',
                'Perfect for fitness, competition, or fun',
        ...
        <div className="mt-20 text-center">
          <p className="text-sm text-lbta-secondary mb-8">Join 200+ adults improving their game in Laguna Beach</p>
