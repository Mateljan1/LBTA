  ...
  return (
    <>
                ...
                <AnimatedSection key={principle.title} delay={index * 0.1}>
                  <div className="card-luxury p-8 md:p-10 h-full">
                    <div className="flex items-start space-x-4 mb-6">
                      ...
                      <h3 className="text-xl md:text-2xl font-display font-light text-clay-900 mt-1">
                        {principle.title}
                      </h3>
                    </div>
              ...
              <AnimatedSection key={item.phase} delay={index * 0.1}>
                <div className="card-luxury p-8 md:p-10">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <h3 className="text-xl md:text-2xl font-display font-light text-clay-900">
                      {item.phase}
                    </h3>
                  </div>
      ...
      <section className="section-spacing bg-clay-900 text-sand-100">
        <div className="container-narrow text-center">
          <AnimatedSection>
            <blockquote className="text-2xl md:text-3xl font-display font-light leading-relaxed mb-8">
