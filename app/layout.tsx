  ...
  return (
    <html lang="en" className={`${workSans.variable} ${playfair.variable}`}>
      ...
      <body className={`${workSans.className} flex flex-col min-h-screen`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-lbta-orange focus:text-white focus:rounded-md focus:outline-none focus:ring-2 focus:ring-white"
        >
