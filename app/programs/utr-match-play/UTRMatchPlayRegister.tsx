...
function buttonClass(variant: Variant): string {
  ...
  if (variant === 'hero-teal') {
    return 'inline-flex items-center justify-center rounded-lg bg-brand-victoria-cove px-7 font-sans text-[15px] font-bold text-white min-h-[48px] transition-opacity hover:opacity-[0.92] focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-victoria-cove focus-visible:ring-offset-2 focus-visible:ring-offset-[#0f2237]'
  }
  return 'btn-primary'
}
