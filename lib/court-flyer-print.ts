...
/** Logo strip: City circle outer diameter; LBTA wordmark uses same cap height (px at 1:1). */
export const COURT_FLYER_LOGO_ROW_PX = 64
/** City seal artwork inside the circle (slight inset so both marks read balanced). */
export const COURT_FLYER_CITY_SEAL_INNER_PX = 56
