...
const ENV_VARS = {
  ...
  /** Stripe webhook signing secret for /api/webhooks/stripe (Vercel only; never commit) */
  STRIPE_WEBHOOK_SECRET: 'Stripe webhook signing secret (optional; required for UTR checkout fulfillment)',
